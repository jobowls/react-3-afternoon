...
export default class Post extends Component {
  ...
  render() {
    ...
    const { editing, showMasterMenu, deletePostFn, updatePostFn} = this.state;
    ...
    <span className="Post__date">- { date } </span>
        ...
        */}
        <div className="Post__content">
          ...
          {editing ? <Edit text={text} id={id} hideEdit={ this.hideEdit } updatePostFn={updatePostFn} /> : <span className="Post__text"> {text} </span>}
